...
<div class="container-fluid card">
                ...
                <div class="form-group mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col text-end">
                                <strong>{{ auth()->user()->wallet }}</strong> <br>
    ...
    <div class="row my-3">
        <div class="col"></div>
        <button class="btn rounded-5 text-white col-5 mx-5 text-center" style="background: #55AAAD"><strong>Complete to Payment</strong></button>
    </div>
</div>
