                ...
                <div class="text-center">
                    ...
                    <div class="mt-5">
                        <a class="btn rounded-5 text-white"
                            style="background: #55AAAD; padding-right: 90px; padding-left: 90px" href="{{ route('profile.show') }}"><strong>My
                                Account</strong></a>
                        <a class="btn rounded-5 text-white mt-3"
                            style="background: #4C5370; padding-right: 90px; padding-left: 90px" href="{{ route('shipping.myPurchase') }}"><strong>My
                                Purchase</strong></a>
                    </div>
                </div>
            </div>
            <div class="col-10 mt-3">
                <div class="container-fluid card">
                    <div class="card-header row">
                        ...
                        <div class="col-2 text-end"><a class="btn rounded-5 text-white" href="{{ route('post.index') }}"
                                style="background: #4E6A80"><strong>Marketplace</strong></a>
                            <a href="/" class="btn rounded-5 text-white" style="background: #4E6A80"><i
                            ...
                            <div class="mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-9 text-end">
                                        <span style="color: #8A8A8A"><i class="fas fa-truck"></i> Seller is preparing your
                                            order
                                        </span>
                                    </div>
                                </div>
