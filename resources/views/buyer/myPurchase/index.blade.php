    ...
    <div class="col-10">
        <div class="container-fluid card">
            <div class="card-header row">
                <div class="col-2"><h2 class="">My Purchase</h2></div>
            ...
            <div class="card-body">
                ...
                @foreach ($shipments as $shipment)
                    <div class="mt-3">
                        <div class="row">
                            <div class="col-1">
                                <h5 style="text-transform: uppercase; font-weight: 700">{{ $shipment->product->user->first_name }}</h5>
                            </div>
                            <div class="col-2">
                        ...
                        <div class="row " style="border-top: 1px solid #D9D9D9; border-bottom: 1px solid #D9D9D9; ">
                            <div class="col-2 my-4 text-center">
                                <img class="border border-5 rounded-5" src="{{ asset('storage/' . $shipment->product->productImages->first()->image_path) }}" alt="img" height="130" width="140">
                            </div>
                            <div class="col-6 mt-5">
                                <strong style="text-transform: uppercase; font-size: 19px">{{ $shipment->product->product_description }}</strong> <br>
                            ...
                            <div class="col-4 text-end" style="margin-top: 5%">
                                <a href="{{ route('shipping.tracking', $shipment->id) }}" class="" style="font-size: 19px; color: #55AAAD; text-decoration: none"><strong>View Details</strong></a> <br>
                                <span style="font-size: 15px; color: #FF2500">P {{ number_format($shipment->total, 2) }}</span>
                            </div>
                        </div>
                    </div>
                    @php
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-4 row">
                        ...
                        <h5 class="col text-center">Order Total:</h5>
                         <h5 class="col text-end" style="color: #FF2500; font-weight: 800">{{ number_format($grandTotal, 2) }}</h5>
                    </div>
                </div>
            </div>
        </div>
